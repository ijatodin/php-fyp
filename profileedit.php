    ...
    <body style="background-color: #dfe7f1;">
        ...
        <div class="container"><a class="navbar-brand" style="color: rgb(0,0,0);" href="#"><strong>Sistem Akses Pintu</strong></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1" style="background-color: #000000;"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon" style="background-color: rgba(255,255,255,0);"></span></button>
            <div
                ...
                <a class="btn btn-primary border rounded shadow-sm action-button" type="submit" style="background-color: rgba(173,0,255,0.52);color: rgb(0,0,0);" href="profileedit.php?logout='1'">Log Keluar</a></div>
        </div>
    </nav>
        <?php
        // put your code here
        ...
        <div class="login-clean" style="background-color: #dfe7f1;">
         ...
         <form action="profileedit.php" method="POST">
            <?php $results = mysqli_query($db, "SELECT * FROM users WHERE id='$sessionid'"); ?>
            ...
            <div class="form-group">
                <label>Nama</label>
                <input class="form-control" type="text" name="username" placeholder="Nama" required="" value="<?php echo $row['username']; ?>">
            </div>
            <div class="form-group">
		<label>Emel</label>
                <input class="form-control" type="email" name="email" placeholder="Emel" required="" value="<?php echo $row['email']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="user_type" name="user_type" value="<?php echo $row['user_type']; ?>" readonly="">
            </div>
            <?php } ?>
            <div class="form-group text-center">
            <button class="btn btn-primary btn-block" type="submit" name="update_btn" style="background-color: rgb(71,130,244);">Kemaskini</button>
